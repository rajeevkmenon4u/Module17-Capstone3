...
## Data Analysis
   ...
   #### Deciosn to use the small dataset which is better from the Balalnced prespective need to run the model as decide further
...
Run the model again t the full data which
